...
const TodoItem = ({name,done, important, myday}) => {
    ...
    //     try{
    //         await service.deleteTodo(todoName)
    ...
    return (
        ...
        <ContextMenuTrigger id={name}>
            <div id={name} className='flex hover:bg-gray-100 bg-white rounded-lg shadow-md px-4 py-2 content-center space-x-2'>
                ...
                <svg data-for='importance' data-tip={importance ? 'cancel important' : 'set important'} data-iscapture='true' t="1629288096179" 
                ...
                <svg t="1629439312415" data-for='myday' data-tip='set to myday' data-iscapture='true' onClick={()=>{setDay(!day)}} fill={mydayColor} className="my-auto outline-none" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3695" data-spm-anchor-id="a313x.7781069.0.i5" width="1.5rem" height="1.5rem"><path d="M512 85.333333a426.666667 426.666667 0 0 1 426.666667 426.666667 426.666667 426.666667 0 0 1-426.666667 426.666667A426.666667 426.666667 0 0 1 85.333333 512 426.666667 426.666667 0 0 1 512 85.333333m-42.666667 618.666667l298.666667-298.666667-60.16-60.16L469.333333 583.253333l-131.84-131.413333L277.333333 512l192 192z" p-id="3696" data-spm-anchor-id="a313x.7781069.0.i4" className="selected"></path></svg>
                <ReactTooltip id='myday' type='info' />
            </div>
        </ContextMenuTrigger>
        <ContextMenu id={name} >
            <MenuItem className='flex' onClick={() => {console.log('hja')}}>
                <FaStar className='text-red-500' />
                <span>Set important</span>
            </MenuItem>
            <MenuItem>
                <FaCheckCircle className='text-blue-500' />
                <span>set to my day</span>
            </MenuItem>
            <MenuItem divider className='text-black' />
            <MenuItem>
                <FaTrash />
